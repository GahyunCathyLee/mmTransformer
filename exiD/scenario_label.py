...
# -*- coding: utf-8 -*-
"""
python exiD/scenario_label.py --h5 exiD/baseline/test.h5 --raw_dir exiD/raw --out_csv exiD/baseline/scenario_labels.csv
scenario_label.py  —  mmTransformer exiD용 scenario_labels.csv 생성 스크립트

h5 파일의 NAME 필드({rec_id}_{trackId}_{obs_frame})를 읽고,
raw exiD CSV에서 lane-change / traffic-state 정보를 추출해 라벨링한다.
...
# 8 neighbor slots (exiD tracks CSV 컬럼 순서, preprocess.py NEIGHBOR_COLS_8와 동일)
NEIGHBOR_COLS_8 = [
    "leadId",            # slot 0
    "rearId",            # slot 1
    "leftLeadId",        # slot 2
...
def parse_args() -> argparse.Namespace:
    ap = argparse.ArgumentParser(
        description="mmTransformer exiD scenario label generator",
